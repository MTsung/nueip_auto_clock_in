<?php
/**
 * https://github.com/MTsung/LINE_Notify_PHP/blob/master/class/lineNotify.class.php
 */
...
class LineNotifyService
{
    ...
    public function __construct()
    {
        ...
        $this->callback = env('LINE_NOTIFY_CALLBACK');
    }
     ...
     * @param  array    $data
     */
    public function snedNotify($token, $data)
    {
